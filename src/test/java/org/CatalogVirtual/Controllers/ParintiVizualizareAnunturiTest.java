...
class ParintiVizualizareAnunturiTest {
    @AfterAll
    ...
    void setUp()throws Exception{
        ...
        AnuntService.addAnunt("Sedinta!","Manta Denisa","Voiculescu Daniela");
    ...
    @Test
    void testVizualizareAnunturi(FxRobot robot) {
        robot.clickOn("#usernameField");
        robot.write("daniela");
        robot.clickOn("#passwordField");
        robot.write("123");
        robot.clickOn("#buttonLogare");
        robot.clickOn("#butonAnunturi");
        robot.clickOn("#butonInapoi");
